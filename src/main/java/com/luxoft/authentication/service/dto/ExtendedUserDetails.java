...
public class ExtendedUserDetails implements UserDetails {
    ...
    private static final long serialVersionUID = 5235244017518497042L;
    ...
    public ExtendedUserDetails(Long id, String username, Integer age, String firstName, String lastName, String password, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        ExtendedUserDetails user = (ExtendedUserDetails) o;
